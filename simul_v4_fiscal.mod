// V4 Fiscal Expansion Shock Simulation
// Unanticipated one-time 1% GDP government spending increase
// g_lso jumps by 0.01 (1% of GDP), decays at rho_g=0.70
var
...
// 1% GDP fiscal expansion shock
shocks;
    var eps_g_lso; stderr 0.01;
end;
