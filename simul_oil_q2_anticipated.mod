// 10% Oil Price Shock at Q1, Sustained Q1-Q4 - ANTICIPATED (perfect foresight)
// Agents know at Q1 that oil will remain elevated through Q4, then decay naturally
// Charts show Q0 (steady state) at origin for clean visual presentation
...
// V4 calibration (reverted lambda_4=0.03, lambda_5=0.05 per SA team feedback)
...
// Shock sequence: Q1=initial jump, Q2-Q4=maintenance, Q5+=natural decay
// To hold poil_gap=0.10 for Q1-Q4 with rho_oil=0.80:
//   Q1: eps = 0.10 (initial jump from 0 to 0.10)
//   Q2: eps = 0.02 (maintain: 0.10 - 0.80*0.10 = 0.02)
//   Q3: eps = 0.02 (maintain)
//   Q4: eps = 0.02 (maintain)
//   Q5+: eps = 0 (natural decay)
// Agents know full path at Q1 (perfect foresight from Q1 onwards)
shocks;
    var eps_oil;
    periods 1     2     3     4;
