// =========================================================================
// V4 Combined Global Recession Scenario
// =========================================================================
// Global demand shock + oil price shock calibrated to hit:
//   y_zaf  = -1.6pp at Q4,  -3.1pp at Q8
//   pi_zaf = +2.2pp at Q4,  +3.3pp at Q8
//
// Three shock channels:
//   1. eps_y_row  = -0.015 sustained Q1-Q8 (US recession, -1.5pp per quarter)
//   2. eps_y_zaf  = two-phase SA demand shock (calibrated for output targets)
//   3. eps_oil    = two-phase oil price shock (calibrated for inflation targets)
//
// Cross-effects accounted for via simultaneous 4x4 calibration.
// =========================================================================
...
initval;
    y_lso=0; pi_lso=0; i_lso=0; r_lso=0; z_lso=0; s_lso=0;
    res_gap_lso=0; res_lso=4.70; res_bar_lso=4.70; prem_lso=0; g_lso=0;
    y_zaf=0; pi_zaf=0; i_zaf=0; r_zaf=0; z_zaf=0; s_zaf=0;
    y_row=0; pi_row=0; i_row=0;
    pi_oil=0; pi_food=0; poil_gap=0; pfood_gap=0;
    rcom=0; rcom_bar=0; d_rcom=0; pi_com=0;
end;
...
// =========================================================================
// Deterministic shock sequence (Q1-Q8, two-phase calibration)
// Calibrated via Jacobian method within perfect foresight framework
// to hit: y_zaf(Q4)=-1.6pp, y_zaf(Q8)=-3.1pp,
//         pi_zaf(Q4)=+2.2pp, pi_zaf(Q8)=+3.3pp
// =========================================================================
shocks;
    var eps_y_row;  periods 1:8;
                    values -0.015;
    var eps_y_zaf;  periods 1 2 3 4 5 6 7 8;
                    values 0.01003856 0.01003856 0.01003856 0.01003856 0.02006318 0.02006318 0.02006318 0.02006318;
    var eps_oil;    periods 1 2 3 4 5 6 7 8;
                    values 0.29660924 0.29660924 0.29660924 0.29660924 0.73376950 0.73376950 0.73376950 0.73376950;
end;

perfect_foresight_setup(periods=60);
