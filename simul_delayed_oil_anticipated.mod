// Delayed Oil Price Shock — Anticipated (perfect foresight)
// 10% oil price level increase sustained Q3-Q6, agents know full path at t=0
var
...
// Delayed sustained shock: hold poil_gap=0.10 for Q3-Q6
// eps_oil sequence: Q3=0.10, Q4-Q6=0.02 (with rho_oil=0.80)
// Agents know full path at t=0 (anticipation effects in Q1-Q2)
shocks;
    var eps_oil;
    periods 3     4     5     6;
