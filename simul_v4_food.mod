// V4 Food Price Shock Simulation
// Unanticipated one-time 10% food price LEVEL shock
// pfood_gap jumps by 0.10, decays at rho_food=0.60
var
...
// 10% food price level shock
shocks;
    var eps_food; stderr 0.10;
end;
