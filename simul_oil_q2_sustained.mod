// Oil Price Shock — 10% Sustained 4 Quarters, Q2 Start (Unanticipated)
// V4 model. stoch_simul base IRF; Q2 start and superposition handled in chart script.
var
...
// Calibration (V4 — recalibrated 2026-03-08)
...
// Base IRF for eps_oil = 0.10 (one std dev)
// Q2 start and 4-quarter sustained path constructed via superposition in chart script
shocks;
