...
residual = zeros(23, 1);
    ...
    residual(7) = (y(24)) - (params(13)*y(4)-params(14)*y(6)-y(2)*params(15)+x(it_, 5));
    residual(8) = (y(26)) - ((1-params(16))*params(17)+params(16)*y(5));
    residual(9) = (y(25)) - (y(24)+y(26));
    residual(10) = (y(27)) - (params(18)*(y(26)-y(25))+x(it_, 6));
    residual(11) = (y(28)) - (y(6)*params(37)+x(it_, 7));
