// Delayed Oil Price Shock — Unanticipated
// 10% oil price level increase sustained Q3-Q6, then natural decay
// Uses stoch_simul for base IRFs; sustained shock constructed via superposition
var
...
// Base IRF: single unanticipated 10% oil shock
// Delayed sustained shock (Q3-Q6) constructed via superposition in chart script
shocks;
